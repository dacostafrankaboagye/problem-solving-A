...
least two letters. beast and dish may contain hyphens and spaces, but these will not appear at the beginning or end of the string.
...
fun feast(beast: String, dish: String): Boolean {
    ...
    var a : Boolean = beast.first() == dish.first()
    var b : Boolean = beast.last() == dish.last()
    return a && b
}
